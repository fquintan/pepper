...
typedef struct sha1_in {uint32_t msg[16];} sha1_in; //Message is preprocessed 
...
typedef struct sha1_out {uint32_t sha1[5];} sha1_out; //sha1 hash (160 bits).
...
void compute_sha1(sha1_in *input, sha1_out *output){
  int i;
  uint32_t w[80]; 
