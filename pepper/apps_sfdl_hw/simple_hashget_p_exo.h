#ifndef APPS_SFDL_GEN_SIMPLE_HASHGET_P_EXO_H_
#define APPS_SFDL_GEN_SIMPLE_HASHGET_P_EXO_H_

#include <apps_sfdl_gen/simple_hashget_p.h>
...
*/
class simple_hashgetProverExo : public ExogenousChecker {
  public:
    simple_hashgetProverExo();
...
#endif  // APPS_SFDL_GEN_SIMPLE_HASHGET_P_EXO_H_
