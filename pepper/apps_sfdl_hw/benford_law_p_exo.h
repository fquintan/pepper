#ifndef APPS_SFDL_GEN_BENFORD_LAW_P_EXO_H_
#define APPS_SFDL_GEN_BENFORD_LAW_P_EXO_H_

#include <apps_sfdl_gen/benford_law_p.h>
...
*/
class benford_lawProverExo : public ExogenousChecker {
  public:
    benford_lawProverExo();
...
#endif  // APPS_SFDL_GEN_BENFORD_LAW_P_EXO_H_
