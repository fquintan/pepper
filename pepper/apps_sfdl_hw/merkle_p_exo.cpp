#include <apps_sfdl_hw/merkle_p_exo.h>
...
merkleProverExo::merkleProverExo() {
...
//using namespace merkle_cons;

void merkleProverExo::init_exo_inputs(
  const mpq_t* input_q, int num_inputs,
  char *folder_path, HashBlockStore *bs) {
  
}

void merkleProverExo::export_exo_inputs(
  const mpq_t* output_q, int num_outputs,
  char* folder_path, HashBlockStore *bs) {

}

void merkleProverExo::run_shuffle_phase(char *folder_path) {

}

void merkleProverExo::baseline_minimal(void* input, void* output){
  //Run the computation
}

void merkleProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//check.
bool merkleProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
