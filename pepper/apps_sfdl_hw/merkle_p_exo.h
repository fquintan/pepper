#ifndef APPS_SFDL_GEN_MERKLE_P_EXO_H_
#define APPS_SFDL_GEN_MERKLE_P_EXO_H_

#include <apps_sfdl_gen/merkle_p.h>
...
*/
class merkleProverExo : public ExogenousChecker {
  public:
    merkleProverExo();
...
#endif  // APPS_SFDL_GEN_MERKLE_P_EXO_H_
